...
Локальный MCP для чтения, редактирования и создания макетов с нуля через Figma Plugin API. Версия 0.6.3: переносимый пакет и скилл с профилем shadcn/ui, правилами проекта и сценарием style guide → компоненты → экраны.
...
Передайте `dist/figma-local-design-skill-0.6.3.zip`. Получателю достаточно установить папку `figma-local-design` как скилл и написать агенту:
